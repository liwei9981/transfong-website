...
FILES="index.html ai-immersion.html ai-acceleration.html privacy.html internship.html tech-fellows.html styles.css immersion.css acceleration.css fellows.css script.js immersion.js acceleration.js fellows.js favicon.png"
cp $FILES "$STAGE/"
